...
public class DictionariesController {
    ...
    @ResponseBody
    public PageInfo findAllDictionaries(@RequestParam(value = "pageNum",defaultValue = "1") Integer pageNum,@RequestParam(value = "pageSize",defaultValue = "10") Integer pageSize, Dictionaries dictionariesMessage){
        return dictionariesService.findAllDictionaries(pageNum,pageSize,dictionariesMessage);
    }
